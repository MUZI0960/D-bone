package kr.or.ddit.kakaoapi.service;
...
public class KakaoPayService {
    ...
    static final String admin_Key = "${3fb97369b8ee1174b7750985a8ccdc00}"; // 공개 조심! 본인 애플리케이션의 어드민 키를 넣어주세요
